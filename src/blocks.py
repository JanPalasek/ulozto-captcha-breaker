...
class ResBlock(Layer):
    ...
    """
    def __init__(self, filters, l2, **kwargs):
...
class ResBlockStrided(Layer):
    """
    Represents the Residual Block in the ResUNet architecture.
    """
    def __init__(self, filters, strides, l2, **kwargs):
        super(ResBlockStrided, self).__init__(**kwargs)
        self.filters = filters
    ...
    def get_config(self):
        return dict(filters=self.filters, strides=self.strides, **super(ResBlockStrided, self).get_config())